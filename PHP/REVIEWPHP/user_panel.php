...
<link
    ...
    rel="stylesheet"
  />
<title>Vinnie's Tratoria User Panel</title>
<style>
body {
  font-size: 14px;
  line-height: 20px;
...
<div class="wrapper">
		...
		<h2>CHECK OUT YOUR REVIEWS ABOUT US</h2>
		<div class="table">
	  ...
	  <div class="cell">
        Actions
				...
				<?php
					...
					session_start();
                    $user = $_SESSION['user']; 
                    $query = mysqli_query($conn, "SELECT * FROM `reviews` WHERE Email='$user'");
					while($row=mysqli_fetch_array($query))
					{
						?>
						 <div class="row">
							...
							<a href="user_delete.php?id=<?php echo $row['ID']; ?>&table=reviews">Delete</a>
							</div>
						</div>
					<?php
					}
	...
	<h2 class="back"><a href="reviews.php">BACK</a></h2>
</body>
</body>
</html>